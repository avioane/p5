...
// this function will be called when the google maps api failed to load
function errorHandling() {
  console.log("Error with loading Google Maps API");
  alert("Error with loading Google Maps API");
}

// this function will be called when the google maps api is loaded; Mundelein; creates the map; defines initial hardcoded locations
function initialize() {
  ...
  // moved applyBindings from the end of the file 
...
var MapViewModel = function() {
  ...
  self.filterLocations = ko.computed(function() {
    console.log("in filterLocations");
